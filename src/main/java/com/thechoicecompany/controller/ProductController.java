...
//@Tag(name = "Products", description = "Product catalogue — public read access")
...
//            productService.listProducts(category, featured, page, size, sort)
//        ));
//    }
//
//    @GetMapping("/slugs")
//    @Operation(summary = "Get all active product slugs (for Next.js generateStaticParams)")
...
//
//    @GetMapping("/featured")
//    @Operation(summary = "Get featured products for home page")
